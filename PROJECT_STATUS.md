...
Last updated: 2026-09-16, after Prydz Bay became the second fully-built region (see section 6 for its real, mixed results — sea-ice forecast is a genuine win, iceberg drift validation is a genuine, informative failure). See "Live status" below for the Weddell retrain's methodology lesson, still relevant before you compare your own checkpoints.
